...
Page({
  ...
  //data
  data:{
    buildData:app.globalData.map[0].data_gaoxin,
    hidden:true,
    search_hidden:true,
    markers:[],
    inputvalue:'',
    ...
    place_img_src:[""],
    modalname:"",
    center_lat:31.818384,
    center_long:117.129484,
  },
  //获取输入的查询地址
    ...
    wx.stopPullDownRefresh() //刷新完成后停止下拉刷新动效       
      ...
      wx.getLocation({
        ...
        success:function(res)
        {
          ...
          if((nowlatitude > 31.815815) && (nowlatitude < 31.821247) && (nowlongitude > 117.124436) && (nowlongitude < 117.134297))
          {
            that.setData({
              markers:[
                {
            ...
            wx.showModal({
              title:'提示',
              content:'检测到当前位置不在高新校区内，是否切换到高新校区默认位置？',
              success(res)
              {
                if(res.confirm)
                {
